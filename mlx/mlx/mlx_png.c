...
#define	ERR_ZLIB	10
#define	ERR_d_MISMATCH	11
#define	ERR_d_FILTER	12
char *(mipng_err[]) =
{
  "No error",
...
int	mipng_d(mlx_img_list_t *img, unsigned char *dat, png_info_t *pi)
{
  unsigned int	len;
  int		b_pos;
